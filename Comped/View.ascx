<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Ragnarok.Modules.RagnarokRegistration.Comped.View" %>
        ...
        <asp:Panel ID="pRegistrationInfo" runat="server">
            ...
            <div>
                <div class="regArea">
                    ...
                    <asp:RadioButton ID="rbAdultSaturday" runat="server" Text="Saturday (06/15/2019) - FREE" CssClass="radioButton" GroupName="RegType" />
                </div>
