...
namespace Ragnarok.Modules.RagnarokRegistration.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Ragnarok.Modules.RagnarokRegistration.Data.SqlDataprovider,RagnarokRegistration";
