<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Ragnarok.Modules.RagnarokRegistration.FinancialEstimate.View" %>
...
<div class="row pad-b-10 pad-t-10">
    <h1>Ragnarok XXXII Financial Estimate Report</h1>
